    ...
    <footer className="bg-gray-800 text-white">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/rooms" className="text-sm hover:underline">Habitaciones</Link></li>
              <li><Link to="/services" className="text-sm hover:underline">Servicios</Link></li>
              <li><Link to="/contact" className="text-sm hover:underline">Contacto</Link></li>
            </ul>
          </div>
          <div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-700 text-center text-sm">
          © {new Date().getFullYear()} AlojamientoSPA. Todos los derechos reservados.
        </div>
      </div>
    </footer>
  )
